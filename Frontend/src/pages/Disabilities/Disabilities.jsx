...
const Disabilities = () => {
  ...
  const limit = 6;
  const API_BASE = "http://localhost:8000/api/disabilities";
  ...
  const fetchDisabilities = async () => {
    try {
      ...
      if (res.data.success) {
        setDisabilities(res.data.data.items || []);
        setTotal(res.data.data.total || 0);
      } else {
        setError("Failed to fetch disabilities");
      }
    } catch (err) {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-10 py-16 md:py-20">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-teal-900 mb-4 tracking-tight">
              Disability Types & Information
            </h1>
            <p className="text-slate-600 text-lg leading-relaxed max-w-2xl">
              Comprehensive guide to understanding different disability types
            ...
            <div className="relative group">
              ...
              <div className="relative flex items-center bg-white backdrop-blur-sm rounded-2xl shadow-2xl px-6 py-4 border border-slate-200">
                ...
                <input
                  ...
                  placeholder="Search by disability type or keyword..."
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-10 py-12">
        {/* Results Summary */}
        {!loading && !error && disabilities.length > 0 && (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-sm text-slate-600 leading-relaxed line-clamp-3">
                    {item.short_desc_en || "No description available."}
                  </p>
